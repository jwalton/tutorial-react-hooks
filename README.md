...
I want to switch to another example.  This is some code I stole almost verbatim
out of video-discovery-web.
...
* Now we have a problem - every time this unmounts, we leak a listener.
    ...
    * Camera example - pass cameraId in props, automatically unsubscribe/resubscribe when cameraId changes.
